---
title: "bkmr"
author: "Katrina Devick and Brent Coull"
date: "8/10/2019; updated 7/26/2022"
output: 
  html_document:
    toc: true
    toc_float: true
...
#save(knots50, knots50, file = "Supervised/BKMR/saved_model/NHANES_knots50.RData") 
```
...
load(paste0(here::here(), "/Supervised/BKMR/saved_model/NHANES_knots50.RData"))
...
load("Supervised/BKMR/saved_model/bkmr_NHANES_gvs_knots50.RData")

summary(fit_gvs_knots50) # provides a lot of info including posterior probabilities, because it is grouped, get 2 inclusion probabilities 
...
modeltoplot      <- fit_gvs_knots50   ## name of model object
modeltoplot.name <- "fit_gvs_knots50" ## name of model for saving purposes
plot.name        <- "gvs_knots50"     ## part that changed in plot name 
Z                <- lnmixture_z        ## Z matrix to match what was used in model

### values to keep after burnin/thin
### I throw out the beginning samples (burn-in) and keep every 10th or 50th 
...
###with traceplots  
TracePlot(fit = modeltoplot, par = "beta", comp=2, sel = sel)
